...
class Client extends EventEmitter {
     ...
     */
     ...
     constructor(token) {
         if (!token) throw new TypeError("Token was not provided to client!");
         //if (typeof token !== "string") throw new TypeError(`Token type must be a string, received ${typeof token}!`);
         super();
